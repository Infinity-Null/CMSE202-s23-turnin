...
class Animal_Agent():
    ...
    def __init__(self,xmax=100,ymax=100,ptype="Prey",sex="M",age_limit=50,catch_radius=10,mate_range=15,gestation=8,shape="o",color="saddlebrown",saturation_pop=150):
        '''
